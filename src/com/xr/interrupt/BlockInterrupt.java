...
public class BlockInterrupt {
    ...
    private static class WhileTryWhenBlock extends Thread {
        ...
        @Override
        public void run() {
            System.out.println("currentThreadd:"+Thread.currentThread().getId());
            while (on && !Thread.currentThread().isInterrupted()) {
                ...
                try {
                    ...
                    System.out.println("currentThreadInterruptFlag:"  +Thread.currentThread().getId() +":"+Thread.currentThread().isInterrupted());
                    Thread.currentThread().interrupt();//重新设置一下
                    System.out.println("interrupted_"+getId()  +":"+isInterrupted());
                    //do my work
                }
                //清理工作，准备结束线程
            }
        ...
        public void cancel() {
            //on = false;
            interrupt();
            System.out.println("currentMethodObject:"+getId());
            System.out.println("currentMethodThread:"+Thread.currentThread().getId());
